...
//launch url
const url = 'https://todo-list-webapp-dun.vercel.app/'

//define selectors
const homepageElement = `//h1[normalize-space()='To do list']`
const btnaddtask = `//button[normalize-space()='Add Task Here']`
const todoInput = `//input[@placeholder='Task Here']`
const todoButton = '.todo-button'
const todoItem = `//p[normalize-space()='testdurga']`
